...
import { OrderinformationComponent } from 'app/core/components/admin/orderinformation/orderinformation.component';
import { WarehouseinformationComponent } from 'app/core/components/admin/warehouseinformation/warehouseinformation.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'orderinformation', component: OrderinformationComponent,canActivate:[LoginGuard]},
    { path: 'warehouseinformation', component: WarehouseinformationComponent,canActivate:[LoginGuard]}
